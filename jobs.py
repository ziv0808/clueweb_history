...
def unite_asrc_data_results(
        ...
        additional_models_to_include = {
            ...
            'MM PrevWinner': {'Folder': '/mnt/bi-strg3/v/zivvasilisky/ziv/results/mixture_model_res/final_res/',
                                'FileTemplate': '<DatasetName>_0<RoundNum>_PrevWinner_Results.txt'},
            'MM Prev3Winners': {'Folder': '/mnt/bi-strg3/v/zivvasilisky/ziv/results/mixture_model_res/final_res/',
                                'FileTemplate': '<DatasetName>_0<RoundNum>_Prev3Winners_Results.txt'},
            'MM PrevBestImprove': {'Folder': '/mnt/bi-strg3/v/zivvasilisky/ziv/results/mixture_model_res/final_res/',
